...
exports.fileServer = exports.FileServer = void 0;
...
class FileServer {
    ...
    async serveFile(req, res, filePath) {
        const fullPath = path_1.default.join(this.downloadDir, filePath);
...
// Singleton
exports.fileServer = new FileServer(process.env.DOWNLOAD_DIR || '/downloads');
