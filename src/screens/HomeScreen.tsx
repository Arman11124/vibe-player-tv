...
export const HomeScreen: React.FC<{ navigation: HomeScreenNav }> = ({ navigation }) => {
    ...
    const sections = React.useMemo(() => [
        { id: 'favorites', title: "❤️ Мои избранные", data: favorites }, // Add Favorites at TOP
        { id: 'trending', title: "В тренде сейчас", data: trending },
        { id: 'trendingTV', title: "Топ 10 сериалов", data: trendingTV },
        { id: 'nowPlaying', title: "Сейчас в кино", data: nowPlaying },
        { id: 'russian', title: "Наше кино", data: russian },
        { id: 'us', title: "Голливудские хиты", data: us },
        { id: 'topRated', title: "Топ рейтинга", data: topRated },
        { id: 'upcoming', title: "Скоро на экранах", data: upcoming },
        { id: 'cartoons', title: "Мультфильмы", data: cartoons },
        { id: 'action', title: "Экшн и боевики", data: action },
        { id: 'comedy', title: "Комедии", data: comedy },
        { id: 'sciFi', title: "Фантастика", data: sciFi },
        { id: 'thriller', title: "Триллеры", data: thriller },
        { id: 'drama', title: "Драмы", data: drama },
        { id: 'european', title: "Европейское кино", data: european },
        { id: 'korean', title: "Азиатская культура", data: korean },
        { id: 'docs', title: "Документальное", data: docs },
    ].filter(s => s.data.length > 0 || s.id === 'favorites'), [
        trending, trendingTV, nowPlaying, russian, us, topRated, upcoming,
        cartoons, action, comedy, sciFi, thriller, drama, european, korean, docs, favorites
    ]);
